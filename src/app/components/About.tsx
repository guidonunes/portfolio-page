...
const About = () => {
  return (
    <section
      className="relative py-12 px-6 dark:bg-gradient-to-br dark:from-slate-950 dark:to-slate-600"
    >
      {/* Centralized Header */}
      <h1 className="text-4xl font-bold text-center text-gray-800 dark:text-gray-200 mb-6 ">About Me</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-center">
        ...
        <div className="text-center md:text-left">
          <h2 className="text-2xl font-semibold text-gray-800 dark:text-gray-200 mb-4">Skills</h2>
